...
Desarrollo MERN Stack que implementa una **Aplicaci車n web para los coleccionistas de loteria nacional**.
...
## Tecnolog赤as de desarrollo

### MERN Stack
MongoDB, Expressjs, React, Nodejs
> MERN es una implementaci車n fullstack en MongoDB, Expressjs, React, Nodejs.
...
Tenga en cuenta que necesita que el cliente y el servidor se ejecuten simult芍neamente en diferentes sesiones de terminal para que se comuniquen entre s赤.

### Uso de la base de datos
Con un software de gesti車n de BBDD MongoDB como:
- [MongoDB Compass](https://www.mongodb.com/try/download/compass)

Crear nueva conexi車n: *mongodb://localhost:27017*


### Uso de los endpoints a trav谷s de postman
...
Para implementar la parte frontal de la aplicaci車n:
...
Este repositorio es para la entrega del **TFE** \(**T**rabajo de **F**in de **E**studios\) del Grado en Ingenier赤a Inform芍tica de la **<a href="https://www.unir.net" target="_blank">Universidad Internacional de la Rioja - UNIR</a>**.

Es un desarrollo de una aplicaci車n web para coleccionistas de d谷cimos de loteria nacional.


## Presentaci車n del portal web

La pagina principal de la aplicaci車n es la siguiente:
